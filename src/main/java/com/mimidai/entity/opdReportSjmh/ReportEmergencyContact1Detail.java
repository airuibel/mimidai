 ...
 * 紧急联系人明细
 */
public class ReportEmergencyContact1Detail {
    ...
    public String toString() {
        return " ," + contact_number + ", " + contact_relation + ", " + contact_seq_no + ", "
                + contact_attribute + ", " + contact_type + ", " + contact_name + ", "
                + contact_area + ", " + is_virtual_number + ", " + call_count_1week + ", "
                ...
                + msg_count_1month + ", " + msg_count_3month + ", " + msg_count_6month + ", "
                + is_whole_day_call_3month + ", " + is_whole_day_call_6month + ", "
                + first_time_call_6month + ", " + last_time_call_6month;
    }
