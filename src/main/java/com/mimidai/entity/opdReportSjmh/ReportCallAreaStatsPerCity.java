...
public class ReportCallAreaStatsPerCity {
    private String call_area_city;
    private String call_area_seq_no;
    private String active_day_1call_1month;
    private String active_day_1call_active_1month;
    private String active_day_1call_3month;
    private String active_day_1call_active_3month;
    private String active_day_1call_6month;
    private String active_day_1call_active_6month;
    ...
    private String continue_active_day_over1_1call_1month;
    private String continue_active_day_over3_1call_1month;
    private String continue_active_day_over1_1call_3month;
    private String continue_active_day_over3_1call_3month;
    private String continue_active_day_over1_1call_6month;
    private String continue_active_day_over3_1call_6month;
    private String max_continue_active_day_1call_1month;
    ...
    public String getCall_area_seq_no() {
        return call_area_seq_no;
    }

    public void setCall_area_seq_no(String call_area_seq_no) {
        this.call_area_seq_no = call_area_seq_no;
    }

    public String getActive_day_1call_1month() {
        return active_day_1call_1month;
    }

    public void setActive_day_1call_1month(String active_day_1call_1month) {
        this.active_day_1call_1month = active_day_1call_1month;
    }

    public String getActive_day_1call_active_1month() {
        return active_day_1call_active_1month;
    }

    public void setActive_day_1call_active_1month(String active_day_1call_active_1month) {
        this.active_day_1call_active_1month = active_day_1call_active_1month;
    }
    ...
    public String getActive_day_1call_active_3month() {
        return active_day_1call_active_3month;
    }

    public void setActive_day_1call_active_3month(String active_day_1call_active_3month) {
        this.active_day_1call_active_3month = active_day_1call_active_3month;
    }
    ...
    public String getActive_day_1call_active_6month() {
        return active_day_1call_active_6month;
    }

    public void setActive_day_1call_active_6month(String active_day_1call_active_6month) {
        this.active_day_1call_active_6month = active_day_1call_active_6month;
    }
    ...
    public String getContinue_active_day_over1_1call_1month() {
        return continue_active_day_over1_1call_1month;
    }

    public void setContinue_active_day_over1_1call_1month(String continue_active_day_over1_1call_1month) {
        this.continue_active_day_over1_1call_1month = continue_active_day_over1_1call_1month;
    }

    public String getContinue_active_day_over3_1call_1month() {
        return continue_active_day_over3_1call_1month;
    }

    public void setContinue_active_day_over3_1call_1month(String continue_active_day_over3_1call_1month) {
        this.continue_active_day_over3_1call_1month = continue_active_day_over3_1call_1month;
    }

    public String getContinue_active_day_over1_1call_3month() {
        return continue_active_day_over1_1call_3month;
    }

    public void setContinue_active_day_over1_1call_3month(String continue_active_day_over1_1call_3month) {
        this.continue_active_day_over1_1call_3month = continue_active_day_over1_1call_3month;
    }

    public String getContinue_active_day_over3_1call_3month() {
        return continue_active_day_over3_1call_3month;
    }

    public void setContinue_active_day_over3_1call_3month(String continue_active_day_over3_1call_3month) {
        this.continue_active_day_over3_1call_3month = continue_active_day_over3_1call_3month;
    }

    public String getContinue_active_day_over1_1call_6month() {
        return continue_active_day_over1_1call_6month;
    }

    public void setContinue_active_day_over1_1call_6month(String continue_active_day_over1_1call_6month) {
        this.continue_active_day_over1_1call_6month = continue_active_day_over1_1call_6month;
    }

    public String getContinue_active_day_over3_1call_6month() {
        return continue_active_day_over3_1call_6month;
    }

    public void setContinue_active_day_over3_1call_6month(String continue_active_day_over3_1call_6month) {
        this.continue_active_day_over3_1call_6month = continue_active_day_over3_1call_6month;
    }

    public String getMax_continue_active_day_1call_1month() {
        return max_continue_active_day_1call_1month;
    }

    public void setMax_continue_active_day_1call_1month(String max_continue_active_day_1call_1month) {
        this.max_continue_active_day_1call_1month = max_continue_active_day_1call_1month;
    }
    ...
    public String toString() {
        return " ," + call_area_city + ", " + call_area_seq_no + ", " + active_day_1call_1month
                + ", " + active_day_1call_active_1month + ", " + active_day_1call_3month + ", "
                + active_day_1call_active_3month + ", " + active_day_1call_6month + ", "
                + active_day_1call_active_6month + ", " + call_count_1month + ", "
                + call_count_3month + ", " + call_count_active_3month + ", "
                + call_count_passive_3month + ", " + call_count_workday_3month + ", "
                + call_count_holiday_3month + ", " + call_count_6month + ", "
                + call_count_active_6month + ", " + call_count_passive_6month + ", "
                + call_count_workday_6month + ", " + call_count_holiday_6month + ", "
                + call_time_1month + ", " + call_time_3month + ", " + call_time_active_3month
                + ", " + call_time_passive_3month + ", " + call_time_6month + ", "
                + call_time_active_6month + ", " + call_time_passive_6month + ", "
                + continue_active_day_over1_1call_1month + ", "
                + continue_active_day_over3_1call_1month + ", "
                + continue_active_day_over1_1call_3month + ", "
                + continue_active_day_over3_1call_3month + ", "
                + continue_active_day_over1_1call_6month + ", "
                + continue_active_day_over3_1call_6month + ", "
                + max_continue_active_day_1call_1month + ", "
