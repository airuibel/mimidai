...
public class ReportInfoCheck {
    ...
    public String toString() {
        return " ," + is_mobile_status_active + ", " + is_identity_code_valid + ", "
                + is_identity_code_reliable + ", " + is_net_age_over_3month + ", "
                + is_contact1_called_6month + ", " + is_contact2_called_6month + ", "
                + is_contact3_called_6month + ", " + is_contact4_called_6month + ", "
                + is_contact5_called_6month + ", " + is_home_tel_called_6month + ", "
                + is_work_tel_called_6month + ", " + is_net_addr_call_addr_1month + ", "
                + is_net_addr_call_addr_3month + ", " + is_net_addr_call_addr_6month;
    }
