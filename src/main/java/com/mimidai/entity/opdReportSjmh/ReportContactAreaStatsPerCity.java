...
public class ReportContactAreaStatsPerCity {
    ...
    public String toString() {
        return " ," + contact_area_city + ", " + contact_area_seq_no + ", " + contact_count_1month
                + ", " + contact_count_3month + ", " + contact_count_active_3month + ", "
                + contact_count_passive_3month + ", " + contact_count_mutual_3month + ", "
                + contact_count_call_count_over10_3month + ", " + contact_count_6month + ", "
                + contact_count_active_6month + ", " + contact_count_passive_6month + ", "
                + contact_count_mutual_6month + ", " + contact_count_call_count_over10_6month
                + ", " + call_count_1month + ", " + call_count_3month + ", "
                + call_count_active_3month + ", " + call_count_passive_3month + ", "
                + call_count_late_night_3month + ", " + call_count_work_time_3month + ", "
                + call_count_offwork_time_3month + ", " + call_count_workday_3month + ", "
                + call_count_holiday_3month + ", " + call_count_6month + ", "
                + call_count_active_6month + ", " + call_count_passive_6month + ", "
                + call_count_late_night_6month + ", " + call_count_work_time_6month + ", "
                + call_count_offwork_time_6month + ", " + call_count_workday_6month + ", "
                + call_count_holiday_6month + ", " + call_count_call_time_less1min_6month + ", "
                + call_count_call_time_1min5min_6month + ", "
                + call_count_call_time_5min10min_6month + ", "
                + call_count_call_time_over10min_6month + ", " + call_time_1month + ", "
                ...
                + msg_count_3month + ", " + msg_count_6month;
    }
