 ...
 * 全部联系人统计
 */
public class ReportAllContactStats {
    ...
    public String toString() {
        return " ," + contact_count_1month + ", " + contact_count_3month + ", "
                + contact_count_active_3month + ", " + contact_count_passive_3month + ", "
                + contact_count_mutual_3month + ", " + contact_count_call_count_over10_3month
                + ", " + contact_count_6month + ", " + contact_count_active_6month + ", "
                + contact_count_passive_6month + ", " + contact_count_mutual_6month + ", "
                + contact_count_call_count_over10_6month + ", " + call_count_1month + ", "
                + call_count_3month + ", " + call_count_active_3month + ", "
                + call_count_passive_3month + ", " + call_count_late_night_3month + ", "
                + call_count_work_time_3month + ", " + call_count_offwork_time_3month + ", "
                + call_count_workday_3month + ", " + call_count_holiday_3month + ", "
                + call_count_6month + ", " + call_count_active_6month + ", "
                + call_count_passive_6month + ", " + call_count_late_night_6month + ", "
                + call_count_work_time_6month + ", " + call_count_offwork_time_6month + ", "
                + call_count_workday_6month + ", " + call_count_holiday_6month + ", "
                + call_count_call_time_less1min_6month + ", "
