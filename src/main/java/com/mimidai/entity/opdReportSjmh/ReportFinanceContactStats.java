...
public class ReportFinanceContactStats {
    ...
    public String toString() {
        return " ," + contact_type + ", " + contact_count_1month + ", " + contact_count_3month
                + ", " + contact_count_6month + ", " + call_count_1month + ", " + call_count_3month
                + ", " + call_count_active_3month + ", " + call_count_passive_3month + ", "
                + call_count_6month + ", " + call_count_active_6month + ", "
                + call_count_passive_6month + ", " + call_time_1month + ", " + call_time_3month
                + ", " + call_time_active_3month + ", " + call_time_passive_3month + ", "
                + call_time_6month + ", " + call_time_active_6month + ", "
                + call_time_passive_6month + ", " + msg_count_3month + ", " + msg_count_6month;
    }
